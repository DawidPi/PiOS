...
namespace PiOS {
    ...
    public:
         ...
         * @param binaryTreeMemoryElements size of memory (given in sizeof(std::size_t)) binaryTreeMemory.
         ...
         */
        PiOS::SimpleBuddy create(std::size_t *binaryTreeMemory, std::size_t binaryTreeMemoryElements, void *memory,
                                 std::size_t memorySize) const;

    private:
        PiOS::NodeId::RankType
        calculateBlockSizeExponent(PiOS::FixedSizeBinaryTree<std::size_t>::Depth depth, std::size_t size) const;
    };
